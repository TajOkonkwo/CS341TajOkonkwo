...
/**
 * A simple GUI application that evaluates the strength of a password based on its length and the longest block of characters.
 * 
...
public class PasswordApp {
	...
	private void initialize() {
		...
		lblEnter.setBounds(23, 71, 202, 14);
	...
	public static String evaluate(String password) {
		...
		if (password.length() < 8)
			return "Password is too short at only " + password.length() + " character" + ((password.length() == 1)? "":"s") + ".";
